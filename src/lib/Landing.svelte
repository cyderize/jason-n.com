...
<p>
	I work on the open source constraint modelling language <a href="https://www.minizinc.org"
		>MiniZinc</a
	>, which empowers users to solve discrete optimisation problems in a solver-independent way.
</p>

<p>
	My expertise ranges from developing programming languages to web design and development to high
